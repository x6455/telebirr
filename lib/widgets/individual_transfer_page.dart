...
class _IndividualTransferPageState extends State<IndividualTransferPage> {
  ...
  Future<void> _handleNext() async {
    ...
    // Keep focus on text field to prevent offset
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GestureDetector(
        // Dismiss keyboard when tapping outside, but don't lose focus unexpectedly
        onTap: () {
          _focusNode.unfocus();
        },
  ...
  Widget _buildRecentTile(String name, Color avatarColor) {
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          // Auto-fill phone number when tapping recent contact
